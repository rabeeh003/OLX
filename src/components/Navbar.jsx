        ...
        <>
            <nav className='fixed w-[100vw] bg-white bg-opacity-90 border-b-2' >
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    <NavLink to={'/'} class="flex-2 items-center space-x-3 rtl:space-x-reverse">
                    ...
                    <div class="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
                        ...
                        <div>
                            ...
                            <div className={`z-50 ${isLangOpen ? 'block' : 'hidden'
                                ...
                                <ul class="py-2 font-medium" role="none">
                                    <li>
                                        <Link to={'/signup'} class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-600 dark:hover:text-white" role="menuitem">
                                            Login
                                        </Link>
                                    </li>
                                    <li>
